...
- (void)backGroundThread{
    ...
    NSLog(@"isMainThread = %u",[NSThread isMainThread]);
...
- (void)myThreadRun{
    ...
    NSLog(@"my thread run %@",[NSThread currentThread]);
    //防止线程执行完该方法就死亡
